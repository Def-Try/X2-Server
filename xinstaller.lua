...
local baseurl = "https://raw.githubusercontent.com/Def-Try/X2-Server/main"

local tmpdir = "/tmp/x2" -- temp. dir for files downloads. will be deleted in case of fail and after install
local installdir = "/usr" -- basic installation directory. see also: files

local PROGRAM_NAME = "XServer" -- Name of your program
local PROGRAM_DESCRIPTION = "XServer is a program that handles GUI shells for OpenOS"
local INSTALLER_NAME = PROGRAM_NAME.." Installer" -- name of your installer program
local INSTALLER_DESCRIPTION = "This program will download and install Xserver to your PC" -- description of your installer program
